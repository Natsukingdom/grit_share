...
RSpec.describe PomosController, type: :controller do
  ...
  # Pomo. As you add validations to Pomo, be sure to
  ...
  # PomosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Pomo" do
        expect {
          post :create, params: {pomo: valid_attributes}, session: valid_session
        }.to change(Pomo, :count).by(1)
      end
